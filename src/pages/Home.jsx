...
function HeroSection() {
  ...
  const heroImages = [
    ...
    'https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=1920',
    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <AnimatePresence mode="sync">
          <motion.img
            ...
            alt="Aviation and drone operations"
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-navy-950/75 via-transparent to-navy-950/30 z-[1]" />
      </motion.div>

      {/* Circuit pattern overlay */}
      <div className="absolute inset-0 bg-pattern-circuit text-white/[0.015] z-[2]" />
      ...
      >
            ...
            >
              <h1
                className={`font-heading font-bold leading-[0.88] tracking-tight ${
                  word === 'AIRSPACE.' ? 'text-gold-500' : 'text-white'
                }`}
        ...
        <motion.div
          ...
          className="flex items-center gap-4 mt-10 text-sm"
        >
          <div className="flex items-center gap-1.5">
            {[...Array(5)].map((_, i) => (
              <Star key={i} size={14} weight="fill" className={i < business.ratingRounded ? 'text-gold-400' : 'text-gold-400/30'} />
            ))}
            <span className="text-white/50 ml-1">{business.rating}/5</span>
          </div>
          <div className="hidden sm:block h-5 w-px bg-white/15" />
          <div className="hidden sm:flex items-center gap-2">
            <ShieldCheck size={16} weight="fill" className="text-emerald-400" />
            <span className="text-white/50 text-xs uppercase tracking-wider">{hero.trustBadge}</span>
          </div>
        </motion.div>
      </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 top-1/2 -translate-y-1/2 z-20">
        <span className="text-white/15 text-[10px] uppercase tracking-[0.4em] font-heading" style={{ writingMode: 'vertical-rl' }}>
          Halted Aviation &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
/* ================================================================
   2. MARQUEE — Capabilities
   ================================================================ */
function MarqueeTicker() {
  const items = ['DRONE SURVEYING', 'LIDAR', 'AERIAL INSPECTION', 'PRECISION MAPPING', 'PILOT TRAINING', 'BVLOS', 'THERMAL IMAGING', 'PHOTOGRAMMETRY'];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              INTELLIGENCE<br />
              FROM<br />
              <span className="text-gold-500">ABOVE.</span>
            </h2>
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg">
              Founded in 2015, Halted Aviation Cooperation saw what most missed: drone technology was about to
              revolutionize how Africa manages its land, infrastructure, and natural resources.
            </p>
            <p className="text-white/40 text-sm leading-relaxed max-w-lg">
              Today we operate 20+ enterprise UAV platforms across Zimbabwe, Zambia, Mozambique, and Botswana.
              Our team of licensed pilots, GIS analysts, and avionics engineers has completed over 300 missions
              for mining, energy, agriculture, and government clients.
            </p>
            ...
            <div className="flex gap-8 sm:gap-12">
              <div>
                ...
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Missions</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl font-bold">20+</div>
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">UAV Fleet</div>
              </div>
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl font-bold">4</div>
                <div className="text-white/40 text-xs uppercase tracking-wider mt-1">Countries</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  src="https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=600"
                  alt="Aerial mapping data"
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            <h2 className="font-heading font-bold text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 4.5vw, 3.5rem)' }}>
              OUR <span className="text-gold-500">CAPABILITIES</span>
            </h2>
            ...
            >
              ...
              >
                ...
                <div className="absolute top-4 right-4 z-10">
                  <span className="text-gold-500/30 font-heading text-5xl sm:text-6xl font-bold leading-none">{String(i + 1).padStart(2, '0')}</span>
                </div>
...
/* ================================================================
   5. MISSION GALLERY — Horizontal Scroll
   ================================================================ */
function MissionGallery() {
  ...
  const missions = [
    { src: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=600', caption: 'Solar Farm Survey' },
    { src: 'https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=600', caption: 'Dam Inspection' },
    { src: 'https://images.unsplash.com/photo-1508444845599-5c89863b1c44?w=600', caption: 'Geological Mapping' },
    { src: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=600', caption: 'Power Line Audit' },
    { src: 'https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=600', caption: 'Crop Monitoring' },
    { src: 'https://images.unsplash.com/photo-1508444845599-5c89863b1c44?w=600', caption: 'Wildlife Count' },
    { src: 'https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=600', caption: 'Tower Inspection' },
    { src: 'https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=600', caption: 'Mine Pit Survey' },
  ];
        ...
        >
          <div>
            ...
            <h2 className="font-heading font-bold text-white leading-[0.92]" style={{ fontSize: 'clamp(2.5rem, 6vw, 5rem)' }}>
              RECENT <span className="text-gold-500">MISSIONS</span>
            </h2>
          </div>
          <Link to="/projects" className="group text-white/40 text-sm uppercase tracking-wider font-heading flex items-center gap-2 hover:text-gold-500 transition-colors">
...
function StatsBand() {
  ...
  const stats = [
    { number: '300', suffix: '+', label: 'Missions' },
    { number: '20', suffix: '+', label: 'UAV Fleet' },
    { number: '45', suffix: '+', label: 'Specialists' },
    { number: '4', suffix: '', label: 'Countries' },
  ];

  return (
    <section ref={ref} className="relative bg-navy-950 overflow-hidden">
      <div className="absolute inset-0 bg-pattern-circuit text-white/[0.02]" />
...
function WhyChooseUs() {
  ...
  return (
    <section ref={ref} className="bg-navy-900 py-20 sm:py-28 lg:py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div
            initial={{ opacity: 0, x: -40 }}
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 bg-gold-500 text-white p-6 shadow-2xl hidden sm:block">
              <div className="text-3xl font-heading font-bold">{whyChooseUs.experienceYears}</div>
              <div className="text-sm font-semibold text-white/80">{whyChooseUs.experienceLabel}</div>
            </div>
          </motion.div>
          ...
          >
            <div className="w-10 h-[3px] bg-gold-500 mb-6" />
            <span className="text-gold-400 text-xs font-semibold uppercase tracking-[0.2em] mb-3 block">Why Choose Us</span>
            <h2 className="font-heading font-bold text-white leading-[0.92] mb-8" style={{ fontSize: 'clamp(1.8rem, 4vw, 3rem)' }}>
              {whyChooseUs.titleParts.map((part, i) =>
                part.highlight ? <span key={i} className="text-gold-500">{part.text}</span> : <React.Fragment key={i}>{part.text}</React.Fragment>
              )}
            </h2>
            ...
            <div className="space-y-5">
              {whyChooseUs.points.map((point, i) => (
                ...
                >
                  <div className="w-8 h-8 bg-gold-500/15 flex items-center justify-center shrink-0 mt-0.5">
                    <CheckCircle size={16} weight="fill" className="text-gold-500" />
                  </div>
                  <div>
                    <h4 className="text-white font-heading font-bold text-sm uppercase tracking-wide mb-1">{point.title}</h4>
      ...
      <div className="relative z-20 max-w-5xl mx-auto px-5 sm:px-8 lg:px-12 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.8 }}>
          <h2 className="font-heading font-bold text-white leading-[0.88] mb-8" style={{ fontSize: 'clamp(2.2rem, 7vw, 4.5rem)' }}>
            READY FOR<br /><span className="text-gold-500">TAKEOFF?</span>
          </h2>
